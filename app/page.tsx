...
export default function Home() {
  ...
  return (
    <main className="p-10 w-screen mx-auto space-y-10 text-black">
      <h1 className="text-2xl font-bold">Parameter Comparison Tool</h1>
      <h1 className="text-2xl font-bold">Reweld Frame QCP</h1>

      <div className="space-y-4">
        <h2 className="font-semibold">First Dataset (Vertical Values Only)</h2>
        <textarea
      ...
      <div className="space-y-4">
        <h2 className="font-semibold">Second Dataset (Horizontal Values Only)</h2>
        <textarea
          className="w-full p-2 border rounded resize-none"
          rows={3}
